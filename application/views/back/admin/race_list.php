                ...
                <tr>
                    ...
                    <td class="text-right">
                        <a class="btn btn-info btn-xs btn-labeled fa fa-wrench" data-toggle="tooltip" 
                           onclick="ajax_modal('edit', '<?php echo translate('edit_race'); ?>', '<?php echo translate('successfully_edited!'); ?>', 'race_edit', '<?php echo $row['race_id']; ?>')" 
                           data-original-title="Edit" data-container="body">
                               <?php echo translate('edit'); ?>
                        </a>
                        <a class="btn btn-danger btn-xs btn-labeled fa fa-trash" data-toggle="tooltip"
                           onclick="delete_confirm('<?php echo $row['race_id']; ?>', '<?php echo translate('really_want_to_delete_this?'); ?>')"  
